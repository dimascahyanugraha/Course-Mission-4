  ...
  return (
    <div className="min-h-screen bg-[#f6f2e9] flex flex-col">
      ...
      <header className="bg-white py-4 px-8 shadow-sm">
        <h1 className="text-orange-500 font-bold text-lg">videobelajar</h1>
      </header>
...
function LoginPage() {
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <h1 className="text-2xl font-bold text-blue-600">Ini Halaman Login</h1>
    </div>
  );
}

// WAJIB ADA: Ekspor komponen ini
