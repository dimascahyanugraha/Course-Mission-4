        ...
        <div className="bg-white w-full max-w-md rounded-md shadow-md p-8">
          ...
          <form className="mt-6 space-y-4">
            ...
            <div>
              ...
              <input
                type="password"
                className="w-full mt-1 text-sm border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
              />
            </div>
            <div>
            ...
            <button className="w-full bg-green-400 text-white font-semibold py-2 rounded-md hover:bg-green-200 transition">
              Daftar
            </button>
            <button className="bg-green-100 w-full py-2 text-green-500 font-semibold rounded-lg">
              Masuk
            </button>
            <div>
