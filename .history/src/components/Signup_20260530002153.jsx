      ...
      <main className="flex flex-auto justify-center items-center px-4">
        <div className="bg-white w-full max-w-md rounded-md shadow-md p-8">
          ...
          <form className="mt-6 space-y-4">
            ...
            <button className="w-full bg-green-60000 text-green-700 font-semibold py-2 rounded-md hover:bg-green-200 transition">
              Daftar
            </button>
            <button className="bg-green-200 w-full py-2">Masuk</button>
            <div>
